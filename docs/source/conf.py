...
# AIStockPicker_MLPipeline documentation build
...
from AIStockPicker_MLPipeline import __version__ as release

# -- Project information -----------------------------------------------------

project = "AIStockPicker_MLPipeline"
...
htmlhelp_basename = "AIStockPicker_MLPipelinedoc"
...
latex_documents = [
    (
        master_doc,
        "AIStockPicker_MLPipeline.tex",
        "AIStockPicker_MLPipeline Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "AIStockPicker_MLPipeline",
        "Project AIStockPicker_MLPipeline codebase.",
        "Data-Science",
    )
]
